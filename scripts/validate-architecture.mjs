...
const entrypointLimits = new Map([["src/main.js", 80]]);
...
async function assertEntrypointSize() {
  for (const [relativePath, maxLines] of entrypointLimits) {
...
async function assertSourceLayout() {
  for (const required of ["config", "domain", "platform", "store", "ui", "vision"]) {
