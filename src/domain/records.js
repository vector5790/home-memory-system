export function createRecordDomain({
  ...
  function normalizeCandidate(candidate = {}, index = 0, provider = "local-image") {
    ...
    return {
      ...
      catalogTopK: Array.isArray(candidate.catalogTopK) ? candidate.catalogTopK : [],
      ...
      namingDiagnostics: candidate.namingDiagnostics && typeof candidate.namingDiagnostics === "object"
        ? candidate.namingDiagnostics
        : null,
      ocrText: candidate.ocrText || "",
      modelBox: candidate.modelBox || null,
      modelImageMeta: candidate.modelImageMeta || null,
