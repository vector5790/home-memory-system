...
export const visionConfig = {
  ...
  catalogIndexPackage: "/data/vision-index-packages/household-cn-grounding-dino-siglip/",
  ...
  leafClassifier: "/data/vision-leaf-classifier.debug.json",
  ...
  catalogTopK: 5,
  catalogRetrievalTopK: 32,
  catalogNamingEnabled: true,
  catalogNamingDebugMode: "nearest-index",
  catalogNamingDebugModes: ["nearest-index", "classifier", "fusion"],
  leafClassifierEnabled: true,
  leafClassifierTopK: 5,
  leafClassifierFusionWeight: 0.58,
  leafClassifierFusionIndexWeight: 0.42,
  catalogNamingConcurrency: 5,
  catalogEmbeddingBatchSize: 16,
  catalogEmbeddingForegroundCount: 6,
  catalogEmbeddingDirectPathEnabled: true,
  nativeCatalogEmbeddingEnabled: true,
  ...
  owlVitLabelLimit: 48,
  maxWasmThreads: 4,
  candidateCropVersion: "crop-256-v3",
  candidateCropMaxDimension: 256,
  candidateCropQuality: 0.82,
