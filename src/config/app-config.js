...
export const visionConfig = {
  appVersion: "20260528-yolox-household-subject-dino-assisted-3000-v7-threshold-003",
  assetVersion: "20260528-yolox-siglip-preload",
  ...
  catalogIndex: "/data/vision-index.household-cn.grounding-dino-siglip.json",
  ...
  catalogModel: "Xenova/siglip-base-patch16-224",
  catalogEmbeddingModelCandidates: [
    {
    ...
    },
    {
      ...
      role: "default",
      enabled: true,
      note: "Optional local A/B candidate; download with VISION_OPTIONAL_MODELS.",
    },
    {
      id: "siglip2-base-patch16-224",
      modelId: "onnx-community/siglip2-base-patch16-224-ONNX",
      role: "ab-eval",
      enabled: false,
      note: "Optional local A/B candidate; download with VISION_OPTIONAL_MODELS=siglip2.",
    },
  ],
  ...
  catalogTopK: 5,
  catalogNamingEnabled: false,
  catalogRerankerEnabled: false,
  catalogOcrRerankerEnabled: true,
  catalogRerankCandidateLimit: 5,
  catalogRerankEmbeddingWeight: 0.82,
  catalogRerankTextWeight: 0.16,
  catalogRerankClusterWeight: 0.02,
  catalogRerankMinTextScore: 0.08,
  catalogClusterThresholds: [
    {
      id: "home-audio-video",
      label: "家庭影音高混淆类",
      categoryIds: [
      ...
      acceptScore: 0.82,
      acceptMargin: 0.055,
      rerankTextScore: 0.16,
      candidateByDefault: true,
      candidateReason: "high-confusion-cluster",
    },
    {
...
export const furnitureByRoom = {
  kitchen: [{ x: 4, y: 8, w: 26, h: 68, cls: "slim" }, { x: 34, y: 18, w: 25, h: 48, cls: "" }, { x: 65, y: 12, w: 27, h: 62, cls: "slim" }, { x: 22, y: 78, w: 54, h: 10, cls: "" }],
  living: [{ x: 9, y: 42, w: 32, h: 22, cls: "" }, { x: 46, y: 50, w: 42, h: 24, cls: "" }, { x: 12, y: 76, w: 70, h: 8, cls: "slim" }],
  balcony: [{ x: 6, y: 16, w: 26, h: 66, cls: "slim" }, { x: 38, y: 52, w: 24, h: 20, cls: "" }, { x: 68, y: 22, w: 20, h: 54, cls: "slim" }],
  bedroom: [{ x: 6, y: 13, w: 31, h: 67, cls: "slim" }, { x: 43, y: 46, w: 42, h: 24, cls: "" }, { x: 56, y: 20, w: 18, h: 18, cls: "" }],
};
